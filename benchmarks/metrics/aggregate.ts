...
/** Aggregates trace, agent-event, patch, and duration data into benchmark metrics. */
...
/** Checks that a price snapshot has supported schema, finite rates, and required model entries. */
