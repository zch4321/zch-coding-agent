...
async function attachView(
  ...
  const terminal = new Terminal({
    ...
    theme: {
      ...
      brightBlack: palette.terminalBrightBlack,
      brightRed: palette.dangerHover,
      brightGreen: palette.success,
      brightYellow: palette.terminalBrightYellow,
      brightBlue: palette.terminalBrightBlue,
      brightMagenta: palette.terminalBrightMagenta,
      brightCyan: palette.terminalBrightCyan,
      brightWhite: palette.terminalBrightWhite,
    },
  })
