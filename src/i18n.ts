...
const messages = {
  ...
  'en-US': {
    ...
    artifact: {
      ...
      detectModules: 'Detect again',
      detectedModules: 'Detected modules',
      useDetectedModules: 'Use detected modules',
      noModules: 'No modules configured yet.',
      unknownLanguage: 'Unknown language',
      codeBackends: 'Code backends',
      serenaBackend: 'Serena MCP backend',
      backendCommand: 'Start command',
      backendContext: 'Context',
      backendProjectMode: 'Project argument',
      backendProjectModeWorkspace: 'Use current workspace path',
      backendProjectModeCwd: 'Infer from working directory',
      backendProjectModeNone: 'Do not pass a project argument',
      backendLanguageBackend: 'Language backend',
      backendLanguageAuto: 'Serena default',
      backendLogLevel: 'Log level',
      backendLogAuto: 'Default',
      backendStartupTimeout: 'Startup timeout (ms)',
      backendToolTimeout: 'Tool timeout (ms)',
      backendEnableDashboard: 'Dashboard service',
      backendDashboardDefault: 'Serena default',
      backendOpenDashboard: 'Open dashboard on start',
      backendExtraArgs: 'Advanced extra args (one per line)',
      backendLaunchPreview: 'Generated launch command',
      saveProjectConfig: 'Save project config',
      restartBackend: 'Restart backend',
      zchGitIgnoreHint:
        '.zch/ may appear in Git changes. Consider adding .zch/ to the project .gitignore.',
      planState: {
