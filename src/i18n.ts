...
const messages = {
  'zh-CN': {
    ...
    dialogs: {
      ...
      revertTitle: '回退对话？',
      revertText:
        '将复制到该消息为止的历史并新建一个分支，原对话历史不会被修改。后续消息不会出现在新分支中。',
      confirmRevert: '新建回退分支',
      exportFailed: '导出失败',
      importFailed: '导入失败',
      importSuccess: '已导入对话',
    },
  ...
  'en-US': {
    ...
    chat: {
      ...
      revertToHereTitle: 'Branch from this message',
      forkedBadge: 'Fork',
    ...
    dialogs: {
      ...
      revertText:
        'A new branch is created with history copied up to this message. The original conversation history is not modified. Later messages will not appear in the new branch.',
      confirmRevert: 'Create revert branch',
