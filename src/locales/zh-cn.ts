const zhCN = {
  usage: {
    ...
    kinds: {
      ...
      assistant_preferences: '助手偏好',
      agents_context: '项目指令',
      user_input: '用户消息',
      interjection: '补充输入',
      selected_context: '选中上下文',
      runtime_context: '运行环境',
      orchestrator: '编排消息',
      assistant_turn: '助手回复',
      tool_result: '工具结果',
  ...
  artifact: {
    ...
    noBackgroundTasksHint: '当前对话的 Agent、Swarm 和终端会显示在这里。',
    stopTask: '停止',
    closeTerminal: '关闭终端',
    stopRequesting: '请求中',
    stopping: '停止中',
    ...
    terminalLogUnavailable: '终端日志不可用',
    terminalLogEmpty: '暂无输出',
    followingLog: '跟随最新输出',
    followingPaused: '已暂停跟随',
    resumeFollowing: '恢复跟随',
    copyLog: '复制日志',
    logCopied: '已复制',
    logTruncated: '显示最近 200 行，最多 64 KiB。更早的内容已省略。',
    panels: '侧边面板',
    files: '文件',
    diff: '变更',
    plan: '计划',
    ...
    notGitRepository: '当前项目不是 Git 仓库',
    gitRequiredHint: '变更面板仅对 Git 工作树可用。',
    cleanWorkingTree: '当前项目工作树是干净的。',
    statusTruncated: '状态列表已截断。',
    selectBaseRef: '选择基准分支或引用',
    allProjectChanges: '项目全部变更',
    binaryDiff: '二进制文件',
    unbornHead: '尚无 HEAD 提交',
    untrackedNoDiff: '未跟踪文件有 Git 状态，但暂时没有 Git Diff。',
    noGitDiff: '该路径在当前基准下没有 Git Diff。',
    gitMode: {
      head: '相对 HEAD',
      unstaged: '未暂存',
      staged: '已暂存',
      merge_base: '相对 Merge Base',
    },
  ...
  settings: {
    ...
    projectRemovalSafety:
      '移除项目会清理应用内的对话、消息、Subagent 记录和运行资源，但绝不会删除磁盘上的项目目录或文件；Trace 日志仍在“日志”设置中单独管理。',
    archivedTitle: '已归档对话',
    archivedHint: '恢复归档对话，或永久删除不再需要的本地历史。',
    archivedSafety:
      '永久删除会清理该对话的消息，但不会改动工作区文件。存在分叉子对话时会拒绝删除；Trace 日志仍在“日志”设置中单独管理。',
    ...
    deleteArchivedConfirm:
      '永久删除“{title}”的本地会话和消息？此操作不可撤销。工作区文件不会被改动；Trace 日志仍在“日志”设置中单独管理。',
  ...
  dialogs: {
    ...
    revertTitle: '回退对话？',
    revertText:
      '将从此消息开始回退当前对话分支。文件、终端和外部工具产生的副作用不会撤销；请使用 Git 检查或恢复工作区变更。',
    retryMessageText:
