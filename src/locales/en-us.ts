const enUS = {
  usage: {
    ...
    kinds: {
      ...
      agents_context: 'Project instructions',
      user_input: 'User message',
      interjection: 'Live input',
      selected_context: 'Selected context',
      runtime_context: 'Runtime environment',
      orchestrator: 'Orchestration',
      assistant_turn: 'Assistant reply',
  ...
  artifact: {
    ...
    notGitRepository: 'This Project is not a Git repository',
    gitRequiredHint: 'The Diff panel is available only for Git worktrees.',
    cleanWorkingTree: 'The Project working tree is clean.',
    statusTruncated: 'The status list was truncated.',
    selectBaseRef: 'Select a base branch or reference',
    allProjectChanges: 'All Project changes',
    binaryDiff: 'Binary file',
    unbornHead: 'No HEAD commit',
    untrackedNoDiff: 'Untracked files have Git status but no Git diff yet.',
    noGitDiff: 'No Git diff for this path and baseline.',
    gitMode: {
      head: 'vs HEAD',
      unstaged: 'Unstaged',
      staged: 'Staged',
      merge_base: 'vs merge base',
    },
  ...
  settings: {
    ...
    projectRemovalSafety:
      'Removing a project clears its app conversations, messages, Subagent records, and runtime resources. It never deletes the project directory or files from disk; trace logs remain managed separately under Logging.',
    ...
    archivedSafety:
      'Permanent deletion removes the conversation messages without modifying workspace files. Sessions with fork children are protected. Trace logs remain managed separately under Logging.',
    ...
    deleteArchivedConfirm:
      'Permanently delete the local Session and messages for “{title}”? This cannot be undone. Workspace files are not modified, and trace logs remain managed separately under Logging.',
  ...
  dialogs: {
    ...
    revertText:
      'This rewinds the current conversation branch from this message. File, terminal, and external-tool side effects are not undone; use Git to inspect or restore workspace changes.',
    retryMessageText:
