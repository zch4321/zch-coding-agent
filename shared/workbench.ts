...
export const ConversationRecordSchema = Type.Object(
  {
    ...
    parentId: Type.Optional(Type.String({ minLength: 1, maxLength: 256 })),
    parentTitle: Type.Optional(Type.String({ maxLength: 256 })),
    forkPointMessageId: Type.Optional(
      Type.String({ minLength: 1, maxLength: 256 }),
    ),
    forkedAt: Type.Optional(Type.String({ format: 'date-time' })),
    importedFrom: Type.Optional(Type.String({ maxLength: 1_024 })),
    createdAt: Type.String({ format: 'date-time' }),
